...
$status_link="".DIR."memberpage.php";
      $pay_link="".DIR."payment.php";
      
        $subject = "Payment was unsuccessfull";
...
<body style="margin: 0; padding: 0;font-family: "Open Sans", sans-serif;">
 ...
 <table border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:16px;border-collapse:collapse">
  ...
  <tr>
   ...
   There were errors during your payment which caused it to be unsuccessfull.</
   </td>
  </tr>
  ...
  <tr>
   <td style="padding: 5px 0 20px 0;">
    You can retry your payment by clicking the below link. If the amount has been debited from your account then drop a mail at <b>renaissance@mnnit.ac.in</b> 
   </td>
  </tr>
    <tr>
   <td align="center" style="padding: 10px 0 0 0;">
       <a href="'.$pay_link.'" style="text-decoration:none;padding:10px 20px;background-color:#4b9e60;color:white;border-radius:5px">Try again</a>
   </td>
  </tr>
  <tr>
   <td style="padding: 5px 0 5px 0;">
 ...
 <tr bgcolor="#c8e0f4">
   <td style="padding: 20px 0 30px 30px;" >
    ...
    <a href="http://renaissance.mnnit.ac.in" target="_blank" style="text-decoration:none;color:teal">www.renaissance.mnnit.ac.in</a>
        ...
        $altbody = 'Your payment was unsuccessfull.';
    ...
    //else catch the exception and show the error.
        ...
        $error[] = $e->getMessage();
         ...
         echo "<br><p>Your transaction status is ". $status .".</p><br>";
         echo "<p>Your transaction id for this transaction is ".$txnid.". You may try making the payment by clicking the link below.</p><br>";
