	    ...
	    <div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-1 col-md-offset-1 memberDashboard">
			...
			<div class="row">
				...
				<table class="table">
				    <thead>
				      <tr>
				        <th colspan="2"><center><h4><strong>Team Creation</strong></h4></center></th>
				        
				      </tr>
				    </thead>
				    </table>
				This feature will be updated soon. Stay tuned!
				</div>
				</div>
				</div>
				</div>
			...
			<div class="col-md-6 col-xs-12 col-sm-12" style="padding-right: 0px; padding-left: 5px;">
			<div class="memberDetailCard">
			<div class="row">
				<div class="col-sm-12 col-xs-12 col-md-12" style="margin-top: 20px;">
